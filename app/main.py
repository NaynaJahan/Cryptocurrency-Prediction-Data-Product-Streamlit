...
st.set_page_config(
    page_title="Crypto Next-Day High Predictor App",
    page_icon="🪙",
    layout="wide"
)

st.title("Crypto Next-Day HIGH Prediction Predictor App")
...
# ---- Tabs ----
tab_btc, tab_eth, tab_xrp, tab_sol = st.tabs(["Bitcoin (BTC)", "Ethereum (ETH)", "XRP", "Solana (SOL)"])
